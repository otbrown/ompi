...
static int nbc_rallreduce_init(void* sendbuf, void* recvbuf, int count, MPI_Datatype datatype,
...
static inline int allred_sched_diss(int rank, int p, int count, MPI_Datatype datatype, ptrdiff_t gap,
 ...
 cleanup_and_return:
  ...
  /*                                     ompi_request_t ** request, */
  /*                                     struct mca_coll_base_module_2_3_0_t *module) { */
  /*   int res = nbc_rallreduce_init(sendbuf, recvbuf, count, datatype, op, comm, request, module, true); */
  /*   if (OPAL_UNLIKELY(OMPI_SUCCESS != res)) { */
  /*     return res; */
  /*   } */
