...
int
ompi_osc_base_iselect(ompi_win_t *win,
                     void **base,
                     size_t size,
                     int disp_unit,
                     ompi_communicator_t *comm,
                     ...
                     int *model)
{
    ...
    return best_component->osc_iselect(win, base, size, disp_unit, comm, newcomm, info, flavor, 
                                       request, model);
                                  ...
                                  int *model)
{
    ...
    return best_component->osc_complete_iselect(win, base, size, disp_unit, comm, info, flavor,
                                                request, model);
